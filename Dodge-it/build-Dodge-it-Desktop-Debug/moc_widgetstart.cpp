...
#include "../Dodge-it/widgetstart.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_WidgetStart_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 33, 18)
    ...
    "WidgetStart\0on_btnStart_clicked\0\0"
...
void WidgetStart::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_btnHelp_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject WidgetStart::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_WidgetStart.data,
      qt_meta_data_WidgetStart,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_WidgetStart.stringdata))
        return static_cast<void*>(const_cast< WidgetStart*>(this));
